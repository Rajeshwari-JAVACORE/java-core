...
public class Person6 implements Comparable<Person6> {
    ...
    public static void main(String[] args) {
        ...
        people.add(new Person6(1, "Jeminy", 30, 999.0));
        people.add(new Person6(2, "Suresh", 40, 2999.0));
        people.add(new Person6(3, "Papa", 50, 5999.0));
        people.add(new Person6(4, "Jay", 60, 6999.0));
        people.add(new Person6(5, "Jeo", 32, 1999.0));
